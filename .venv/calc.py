...
button_sub = tk.Button(window, text="-", width=2, height=2, command=sub, bg='blue')
button_sub.place(x=150, y=200)
button_mul = tk.Button(window, text="*", width=2, height=2, command=mul, bg='blue')
button_mul.place(x=200, y=200)
button_div = tk.Button(window, text="/", width=2, height=2, command=div, bg='blue')
